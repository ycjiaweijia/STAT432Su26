...
- A stable cluster can suggest a locally coherent group.

Here, "stable" means that the structure persists across reasonable choices of neighborhood parameters, random initializations, metrics, and preprocessing. These patterns provide hypotheses about the original data, not proof, and should be checked using the original distances or nearest-neighbor relationships.
