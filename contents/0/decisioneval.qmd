...
def classification_summary(y_true, prob, threshold=0.5):
    ...
    return {
        ...
        "precision": precision_score(y_true, pred, zero_division=0), # <1>
        "recall": recall_score(y_true, pred, zero_division=0),
        "f1": f1_score(y_true, pred, zero_division=0),
    }
```
1. `zero_division=0` means that if the denominator is 0 the return value will be set to 0. This always happens in this case since some of the counts might be 0.
