...
for name, model in models.items():
    ...
    fitted_pipe = model.best_estimator_ if name == "LassoCV" else model
    n_nonzero = np.sum(fitted_pipe.named_steps["model"].coef_ != 0)
    alpha = (model.best_params_["model__alpha"] if name == "LassoCV"
             else fitted_pipe.named_steps["model"].alpha_ if name != "OLS" else None)
