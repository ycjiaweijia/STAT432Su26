...
In a pipeline you need to name all components. To make it easier you may use `make_pipeline` to use default names for each steps.

```{python}
from sklearn.pipeline import make_pipeline

pipe_easy = make_pipeline(steps={
    StandardScaler(),
    LinearRegression()
})
```
