...
You may specify which scoreing methods useing `scoring` argument. The default choice will be the default choice from the model. In `LinearRegression` case, the default one is `r2`. Note that this `scoring` can accept a list of scoring methods, or a single scoring method. 
