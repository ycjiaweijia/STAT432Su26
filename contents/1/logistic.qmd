...
Suppose all other predictors are held fixed. Increasing $x_j$ by one unit changes the linear predictor by $\beta_j$. Because the linear predictor is the log-odds, increasing $x_j$ by one unit changes the log-odds by $\beta_j$.
...
Since $\beta_j$ is a change in log-odds, exponentiating gives a multiplicative change in odds.
