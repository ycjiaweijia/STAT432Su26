...
The bias-variance tradeoff described above is reflected directly in the shape of the estimated density.

- A small bandwidth produces a highly flexible density estimate that may contain many spurious peaks caused by random sampling noise.
- A large bandwidth produces a smoother density estimate but may hide important features such as multiple modes or skewness.
