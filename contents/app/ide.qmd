...
There are two types of cells in a notebook: Code cell and Markdown cell. We run Python code in code cells, and write markdown texts in Markdown cells. For Statistical learning, usually code cells are codes and Markdown cells are for analysis and explanations.
